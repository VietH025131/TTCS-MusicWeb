...
<template>
  <div class="p-8">
    ...
    <div class="flex items-center w-full relative h-full">
      <img style="width: 140px" :src="artist.albumCover" alt="" />
      <div class="w-full ml-5">
        <div
          class="text-3xl text-white absolute w-full hover:underline cursor-pointer top-0 font-semibold"
        >
          {{ artist.name }}
        </div>
